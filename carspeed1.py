        ...
        for obj in detection:
            ...
            if confidence > 0.5 and classes[class_id] == 'car':
                ...
                if time_difference > 0:
                    ...
                    speed_info = f"Car speed: {speed_mph:.2f} mph, {layer_names}"
                    # Draw the combined information on the frame
                    cv2.putText(frame, speed_info, cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 0), 4)
